...
<head>
    ...
    <script src="/hdcms/node_modules/hdjs/static/requirejs/require.js"></script>
    <script src="/hdcms/node_modules/hdjs/static/requirejs/config.js"></script>
            ...
            <div class="navbar-header">
                <ul class="nav navbar-nav">
                    ...
                    <li class="top_menu active">
                        <a href="{{u('admin.article.lists')}}" class="quickMenuLink">
                    ...
                    <li class="top_menu">
                        <a href="{{u('admin.user.changePassword')}}" class="quickMenuLink">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="{{u('user.loginout')}}">退出</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
            ...
            <div class="panel panel-default">
                ...
                <ul class="list-group menus">
                    <li class="list-group-item" id="3">
                        ...
                        <a href="{{u('category.lists')}}" class="quickMenuLink">
                            分类列表
                        </a>
                    </li>
                    <li class="list-group-item" id="30">
                        ...
                        <a href="{{u('category.post')}}" class="quickMenuLink">
                            添加分类                                            </a>
                    </li>
                </ul>
                <div class="panel-heading">
                ...
                <ul class="list-group menus">
                    <li class="list-group-item" id="3">
                        ...
                        <a href="{{u('article.lists')}}" class="quickMenuLink">
                            文章列表
                        </a>
                    </li>
                    <li class="list-group-item" id="30">
                        ...
                        <a href="{{u('article.post')}}" class="quickMenuLink">
                            添加文章                                            </a>
                    </li>
                </ul>
                <div class="panel-heading">
                ...
                <ul class="list-group menus">
                    <li class="list-group-item" id="3">
                        ...
                        <a href="{{u('slider.lists')}}" class="quickMenuLink">
                            幻灯片列表
                        </a>
                    </li>
                    <li class="list-group-item" id="3">
                        ...
                        <a href="{{u('slider.post')}}" class="quickMenuLink">
                            添加幻灯片
                        </a>
                    </li>
                </ul>
                ...
                <ul class="list-group menus">
                    <li class="list-group-item" id="3">
                        ...
                        <a href="{{u('config.post')}}" class="quickMenuLink">
                            系统设置
                        </a>
                    </li>
                </ul>
