                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="{{u('admin.user.loginout')}}">退出</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
            ...
            <div class="panel panel-default">
                ...
                <ul class="list-group menus">
                    <li class="list-group-item" id="3">
                        ...
                        <a href="?s=admin/user/changePassword" class="quickMenuLink">
                            修改密码
                        </a>
                    </li>
                </ul>
                <div class="panel-heading">
                    <h4 class="panel-title">备份管理</h4>
                    <a class="panel-collapse" data-toggle="collapse" href="javascript:;">
                        <i class="fa fa-chevron-circle-down"></i>
                    </a>
                </div>
                <ul class="list-group menus">
                    <li class="list-group-item" id="3">
                        ...
                        <a href="{{u('system.back.lists')}}" class="quickMenuLink">
                            备份列表
                        </a>
                    </li>
                    <li class="list-group-item" id="3">
                        ...
                        <a href="{{u('system.back.backup')}}" class="quickMenuLink">
                            网站备份
                        </a>
                    </li>
                </ul>
